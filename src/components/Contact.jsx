...
const socials = [
  {
    name: 'GitHub',
    href: 'https://github.com/mikearita',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/mikearita',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="contact__inner">
          ...
          <div className="contact__content">
            ...
            <p className="contact__description">
              Whether you have a project in mind, want to explore a collaboration, or just want to
              say hello — my inbox is always open. I typically respond within 24 hours.
            </p>

            <a href="mailto:hello@mikearita.com" className="contact__email">
              <span>hello@mikearita.com</span>
